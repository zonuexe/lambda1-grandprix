...
var pair D = Fun(func(a D) D { return Fun(func(b D) D { return Fun(func(s D) D { return app(app(s, a), b) }) }) })
var _nil D = Fun(func(n D) D { return Fun(func(c D) D { return n }) })
var cons D = Fun(func(h D) D { return Fun(func(t D) D { return Fun(func(n D) D { return Fun(func(c D) D { return app(app(c, h), t) }) }) }) })
var _true D = Fun(func(t D) D { return Fun(func(f D) D { return t }) })
var _false D = Fun(func(t D) D { return Fun(func(f D) D { return f }) })
var snd D = Fun(func(p D) D { return app(p, _false) })
...
var tint D = Fun(func(k D) D { return app(app(pair, one), k) })
var step D = Fun(func(p D) D { return app(p, Fun(func(k D) D { return Fun(func(l D) D { return app(app(pair, app(pred, k)), app(app(cons, app(tint, k)), l)) }) })) })
var _range D = Fun(func(n D) D { return app(snd, app(app(n, step), app(app(pair, n), _nil))) })
